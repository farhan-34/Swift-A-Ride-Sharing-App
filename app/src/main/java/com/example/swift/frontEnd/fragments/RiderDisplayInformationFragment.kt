 ...
 * Use the [RiderDisplayInformationFragment.newInstance] factory method to
...
class RiderDisplayInformationFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment RiderDisplayInformationFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RiderDisplayInformationFragment().apply {
